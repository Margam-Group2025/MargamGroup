...
const AgriculturePage = () => {
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-green-700 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-12">Our Agricultural Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="p-8 rounded-xl bg-green-800 shadow-xl animate-fade-in">
              <div className="text-5xl font-bold mb-4 text-yellow-400">5K+</div>
              <p className="text-xl">Farmers Empowered</p>
            </div>
            <div className="p-8 rounded-xl bg-green-800 shadow-xl animate-fade-in delay-200">
              <div className="text-5xl font-bold mb-4 text-yellow-400">10K+</div>
              <p className="text-xl">Acres Cultivated Sustainably</p>
            </div>
            <div className="p-8 rounded-xl bg-green-800 shadow-xl animate-fade-in delay-400">
              <div className="text-5xl font-bold mb-4 text-yellow-400">20%</div>
              <p className="text-xl">Increase in Yields</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-white">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-4xl font-bold text-green-900 mb-12 text-center">Connect with Our Agro Experts</h2>
          <form className="bg-white p-10 rounded-xl shadow-lg border border-gray-200">
            <div className="mb-6">
            ...
            <button
              type="submit"
              className="w-full bg-green-700 hover:bg-green-800 text-white font-bold py-4 px-6 rounded-lg text-lg shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              Send Message
            </button>
          </form>
